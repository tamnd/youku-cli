...
// HTTP behaviour is covered in youku_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "youku://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("youku", "about")
	if err != nil || got.String() != "youku://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want youku://page/about", got.String(), err)
	}
}
